    ...
    <main>
        ...
        <section class="flex flex-col w-screen">
            <ul class="grid grid-cols-5 grid-rows-1">
                <li>
                    <a href="#" style="background-color: #27ae60;"
                        class="py-6 text-white font-semibold flex justify-center items-center uppercase space-x-1">
                ...
                <li>
                    <span style="background-color: #0f99f3;"
                        class="py-6 text-white font-semibold flex justify-center items-center uppercase">billing</span>
                </li>
                <li>
