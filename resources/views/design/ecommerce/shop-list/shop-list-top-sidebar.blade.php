...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/tokopedia/shop-list-top-sidebar.css') }}">
</head>
...
<body class="overflow-x-hidden">
    ...
    <main>
        ...
        <section class="px-32 py-15 flex flex-col space-y-8">
            <div class="grid grid-cols-4 grid-rows-2 gap-8">
                ...
                <div class="flex flex-col col-span-2 h-32 px-6 py-6 bg-blue-50 rounded-md space-y-2">
            ...
            <div class="flex flex-col space-y-8 w-full">
                ...
                <div class="grid grid-cols-3 grid-rows-8 gap-8">
                    <div id="product" class="flex flex-row col-span-3 bg-blue-100 rounded-md overflow-hidden">
                        <div class="relative overflow-hidden">
                            <img id="normal_img" class="object-cover" src="{{ asset('images/product_1.png') }}"
                                alt="">
                            <img id="hover_img" class="object-cover absolute top-0"
                        ...
                        <div class="flex flex-col justify-between">
                            <div class="flex flex-col space-y-2 py-5 px-5">
                                <span>LIM</span>
                                ...
                                <p class="text-sm">Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                                    Molestiae modi aspernatur,
                                    delectus doloribus nesciunt </p>
                            </div>
                            <div class="bottom-0 bg-red-500 w-full flex justify-between items-center h-10">
