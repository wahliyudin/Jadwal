...
<body class="overflow-x-hidden">
    ...
    <main>
        ...
        <section class="px-32 py-10 space-y-5">
            <div class="flex flex-col">
                <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                        <div class="overflow-hidden">
                            <table class="min-w-full border border-blue-200 text-center">
                                <thead class="border-b bg-blue-50">
                                    <tr>
                                        <th scope="col" class="font-semibold text-gray-900 px-4 py-4 border-r border-blue-200">
                                            <i class='bx bx-trash text-xl'></i>
                                        </th>
                                        <th scope="col" class="font-semibold text-gray-900 px-6 py-4 border-r border-blue-200">
                                            Image
                                        </th>
                                        <th scope="col" class="font-semibold text-gray-900 px-6 py-4 border-r border-blue-200">
                                            Product
                                        ...
                                        <th scope="col" class="font-semibold text-gray-900 px-6 py-4">
                                            Total
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="border-b border-blue-200">
                                        <td
                                            class="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900 border-r border-blue-200">
                                            <i class='bx bx-x text-xl' ></i>
                                        </td>
                                        <td
                                            class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r border-blue-200 flex justify-center items-center">
                                            <img class="w-16 h-15 object-cover" src="{{ asset('images/product_1.png') }}" alt="">
                                        </td>
                                        <td
                                            class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r border-blue-200">
                                            Bluetooth Speaker
                                        </td>
                                        <td
                                            class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r border-blue-200">
                                        ...
                                        <td
                                            class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r border-blue-200">
                                            <input type="number" class="w-10 bg-blue-100 px-1 outline-none">
                                        </td>
                                    ...
                                    <tr class="border-b border-blue-200">
                                        ...
                                        <td
                                            class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r border-blue-200 flex justify-center items-center">
                                            <img class="w-16 h-15 object-cover" src="{{ asset('images/product_2.png') }}" alt="">
                                        </td>
                                        <td
                                            class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r border-blue-200">
                                            Bluetooth Speaker
                                    ...
                                    <tr class="border-b border-blue-200">
                                        ...
                                        <td
                                            class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r border-blue-200 flex justify-center items-center">
                                            <img class="w-16 h-15 object-cover" src="{{ asset('images/product_3.png') }}" alt="">
                                        </td>
                                        <td
                                            class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r border-blue-200">
                                            Bluetooth Speaker
                                    ...
                                    <tr class="border-b border-blue-200">
                                        ...
                                        <td
                                            class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r border-blue-200 flex justify-center items-center">
                                            <img class="w-16 h-15 object-cover" src="{{ asset('images/product_4.png') }}" alt="">
                                        </td>
                                        <td
                                            class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r border-blue-200">
                                            Bluetooth Speaker
                                    ...
                                    <tr class="border-b border-blue-200">
                                        ...
                                        <td
                                            class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r border-blue-200 flex justify-center items-center">
                                            <img class="w-16 h-15 object-cover" src="{{ asset('images/product_5.png') }}" alt="">
                                        </td>
                                        <td
                                            class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r border-blue-200">
                                            Bluetooth Speaker
            ...
            <div class="flex w-full justify-between items-start">
                <div class="bg-blue-50 px-6 py-6 rounded-md space-y-4 flex flex-col justify-start w-1/2">
                    <span>Have a Coupon?</span>
                    <span class="text-gray-500">Enter your coupon code here & get awesome discounts!</span>
                    <input type="text" class="outline-none text-sm border-2 border-blue-300 px-4 py-2 placeholder-gray-500 rounded-md" placeholder="Enter Your Coupon Code">
                    <div class="flex justify-start">
                        <button class="bg-blue-500 rounded-md text-white outline-none text-sm px-4 py-2 uppercase">apply coupon</button>
                    </div>
                </div>
                <div style="width: 430px;" class="bg-blue-50 px-6 py-6 rounded-md flex flex-col space-y-3">
                    <span class="text-lg">Cart Totals</span>
                    <div class="flex flex-col w-full">
                        <div class="flex justify-between w-full border-t border-gray-300 py-4">
                        ...
                        <div class="flex justify-between w-full border-t border-gray-300 py-4">
                            <span class="font-semibold">VAT (10%)</span>
                            <span class="font-semibold">$56.00</span>
                        </div>
                        <div class="flex justify-between w-full border-t border-gray-300 py-4">
                        ...
                        <span class="py-2 mt-2 text-white text-lg uppercase bg-blue-500 rounded-md flex justify-center items-center">proceed to checkout</span>
                    </div>
                </div>
            </div>
        </section>
    ...
    for (let index = 0; index < btn.length; index++) {
        btn[index].onmouseover = () => {
            show[index].classList.toggle('hidden')
        }
        btn[index].onmouseout = () => {
            show[index].classList.toggle('hidden')
        }
    }
    </script>
